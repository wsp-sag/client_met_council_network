####################################################################
# FullyJointTourParticipationSubmodel_FullTimeWorker_NonMandatory.py
# i.e. participation submodel for person type of Full-Time Worker with a Non-Mandatory DAP pattern
####################################################################
