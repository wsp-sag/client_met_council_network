####################################################################
# FullyJointTourParticipationSubmodel_Child3_Mandatory.py
# i.e. participation submodel for person type of Child3 with a mandatory DAP pattern
####################################################################
...
altSpecificConsts=[0, # base alternative
                  -4.53858  # because constants are segmented by person type, they will be in the segmentations
                   ]  
