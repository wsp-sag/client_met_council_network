...
:: New Roadway Assignment Parameters
SET HWY_ASSIGNITERS=20
SET HWY_HOV2OCC=2.0
SET HWY_HOV3OCC=3.2
SET HWY_TRKFAC=2.00
SET HWY_TOLLSETTING=2
SET VOT_INCOME_01=5.00
SET VOT_INCOME_02=10.00
SET VOT_INCOME_03=15.00
SET VOT_INCOME_04=25.00
SET VOT_INCOME_05=50.00
SET VOT_TRK=15.00
SET AUTO_PER_MILE_COST=0.00
SET TRUCK_PER_MILE_COST=0.00
SET MAX_TOLL_PRICE=800
SET PRICE_ARRAY_SIZE=500
SET HOV_TIME_PENALTY=1.500

SET ASSIGN_LU=%LOOKUP_DIR%\assignable.csv
