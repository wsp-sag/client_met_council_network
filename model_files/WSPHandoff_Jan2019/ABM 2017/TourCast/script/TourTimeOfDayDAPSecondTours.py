####################################################################                                                                                                                                                                                           
# TourTimeOfDayDAPSecondTours.py
...
dataReferences = [
    ...
    {"type" : "dbffile",
     "name" : "Tours",
     "filename" : cube___SECOND_MANDATORY_TOUR_TIME_OF_DAY___,
     "columns" : [
                  "personId", 
                  "hhId", 
                  "persTourId", 
...
# this input would be present for all but dap first tours
   {"type" : "dbffile",
   ...
   {"type" : "dbffile",
     ...
     "filename" : cube___DAP_TOUR_TIME_OF_DAY_PERSON_SCHEDULES_SECOND_TOURS___, # file paths MUST BE RAW strings (preceded by 'r')
     # parameters could be generally of form source data reference : field
     "parameters" : [
                       [ "Person id", "personId"],
...
# the responsibility would have to fall to the submodel to write this data
   {"type" : "dbffile",
     "isOutput": "true",
     "name" : "OutputTODStats",     
     "filename" : cube___DAP_TOUR_TIME_OF_DAY_SECOND_TOUR_CHOICE_SUMMARY___, # file paths MUST BE RAW strings (preceded by 'r')
     # parameters could be generally of form source data reference : field
     "parameters" : [
                       [ "arrival", "arrival"],
                       [ "departure", "departure"],
