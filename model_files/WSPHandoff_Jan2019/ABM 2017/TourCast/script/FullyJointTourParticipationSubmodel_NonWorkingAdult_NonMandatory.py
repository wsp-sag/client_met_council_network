####################################################################
# FullyJointTourParticipationSubmodel_NonWorkingAdult_NonMandatory.py
# i.e. participation submodel for person type of Non-Working Adult with a Non-Mandatory DAP pattern
####################################################################
...
altSpecificConsts=[0, # base alternative
                   -1.36388  # because constants are segmented by person type, they will be in the segmentations
                   ]  
