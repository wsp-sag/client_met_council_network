####################################################################
# FullyJointTourParticipationSubmodel_Senior_NonMandatory.py
# i.e. participation submodel for person type of Senior with a Non-Mandatory DAP pattern
####################################################################
...
altSpecificConsts=[0, # base alternative
                  2.79002  # because constants are segmented by person type, they will be in the segmentations
                   ]  
durableCoeffs=[
  # no       #yes
