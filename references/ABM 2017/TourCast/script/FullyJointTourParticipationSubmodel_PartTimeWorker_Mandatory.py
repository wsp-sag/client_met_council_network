####################################################################
# FullyJointTourParticipationSubmodel_PartTimeWorker_Mandatory.py
# i.e. participation submodel for person type of Part-Time Worker with a mandatory DAP pattern
####################################################################
